    ...
    tabItems(
      ...
      tabItem(
        ...
        fluidPage(
          ...
          for the pertinent issue we explore. With all the options
          ...
          creating a report which illustrates food point usage, Duke undergraudate students can better understand their
          own spending, and use the information to inform any personal spending
          goals they may develop."),
                   p("Ergo, to alleviate the mental hurdles that
          ...
          visual report on their spending. To do this we utilize the information
          available in a student’s personal usage data — accessed through their",
                   a('DukeCard eAccounts login',
                     href = "https://dukecard.duke.edu/manage-your-dukecard"),
                   "— to provide a comprehensive report on their food spending. We consulted
          Duke Dining on the best way to extract food point data and they conccured
          ...
          Excel template, to be uploaded to the R Shiny app. The template includes variables for ",
          em("Date/Time"), "(date and time purchase occurred)", em(", Account Name, "),
          em("Card Number, "), em("Location "), "(restaurant purchase occurred at), ",
          em("Transaction Type, "), "and ", em("Amount"), "(cost of purchase)."),
                 p("Other datasets used to accomplish this goal include ", em("semester.csv,"),"
            which offers a brief summary of each plan, allowing us to quickly
            outline every plan’s offerings. Each observation is one of Duke's 8 offered undergraduate food plans. The accompanying variables are information
            ...
            The data was collected from Duke's", a("Fall 2021",
                                                href = "https://studentaffairs.duke.edu/sites/default/files/2021-07/Food%20Point%20Usage%20Chart%20Fall-%2021.pdf"),
            "and ", a("Spring 2022",
                      href = "https://studentaffairs.duke.edu/sites/default/files/2021-07/Food%20Point%20Usage%20Chart%20Spring-22.pdf"), "Food Point
            Calculators."),
                   p("A comprehensive code book for each data set is located in the",
                   a("GitHub repository",
            ...
            template, the R Shiny app generates a usage report with visualizations.
            The report's purpose is to help its intended audience of undergraduate
            Duke students be better informed about their food point spending
            decision making, thus helping to accomplish any goals they may have set
            for themselves. The dashboard does this by providing students with the
            ...
            limits of their food plan."),
          p("The repository's", a("sample data sets folder", href =
          "https://github.com/vizdata-f21/project-2-out_of_the_boxplots/tree/main/sample%20food%20point%20data%20sets"),
          "contains two sample food point templates filled out with team members'
          data. Users who wish to view the functionality of the app, but who are
          not students or do not have access to eAccounts data, are welcome to upload these samples."),
          ...
          containing a full account of their food point purchases over a selected semester. Users are instructed to visit the upload
          ...
          are most effectively able to inform their food point spending goals."),
            ...
            relevant uploaded information. The Dining Location variable was created
                   based on the authors' knowledge of restaurant locations on campus, with the goal of providing
                   more nuance to location information."),
                 img(
            ...
            weeks with Duke's suggested average weekly spend for a chosen plan. The purpose of this plot is to indicate whether or not a student is
            overspending, on average, and help the user identify the weeks where the
            ...
            Progression.” To obtain our Expected Progression we utilized ggplot's", em("geom_smooth "), "linear
            ...
            deciding on whether to switch food plans in future semesters."),
                 p("In the sample visualization below, created using Matt’s data,
                   ...
                   what occured during these weeks. In Matt’s plot, he spent very
                 ...
                 img(
                   ...
                   The first plot is a bar plot titled 'Spending per Week'. It shows a user's spending per week over the course of a semester
                   ...
                   The second plot is titled 'Plan Progression' and uses a linear regression model to show a user's projected number
            ...
            or less, which may help them remember specific dining buildings that are key
            in the development of their spending goals. The slider on the top of the page provides the ability to choose
            a desired date range in the data to be visualized, helping students see data for a
            specific period of time they may be interested in. If one week's bar stood out on the spending over
            time page, users may wish to view this date range, for example. Additionally, if clicked, each
            pin on the map displays the number of transactions and amount of money
            ...
            img(
              ...
              style = "display: block; margin-left: auto; margin-right: auto;",
              alt = "This figure displays a map titled 'Campus Dining Locations' with all the dining locations at Duke.
            ...
            each bar is filled in with a prominent color from the logo. We photoshopped custom labels for restaurants
            who did not have logos, in order to standardize axis apperances. For those students who wish to see information for restaurants other than
            their top five, a table below the plots contains statistics for all restaurants."),
            img(
            ...
            p("In conclusion, this R Shiny app helps visualize Duke students’
              food point spending, helping our peers accomplish their spending-related
              ...
              spender. Screenshots of these tips can be found below."),
            img(
          ...
          h4("Limitations"),
            p("It is important to note that there are limitations to the project. For
              ...
              the user is uploading their own data into the Shiny app, the data cleaning
              process must be contained within the app's reactive functionality. Further, the colors used in the bar
              ...
              is also limited by the eAccounts data which is available
              ...
              on unnecessary food point usage, such as excessive spending on coffee or snacks."),
          h4("Future Directions"),
            p("In addition, some potentially
              ...
              about the time of purchase, and while but we did not use this information in the dashboard, it may be
              beneficial to users to
              break down food point spending by meal time/type. However, college students
              ...
              the login portal functionality for our peers. This would help everyone be able to more easily
              access a report, helping them to accomplish their personal food point spending
              goals."),
            h3("Code"),
